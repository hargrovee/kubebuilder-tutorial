...
import (
	...
	cronjobv1 "tidy/api/v1"
)

var _ = Describe("CronJob controller", func() {

	//	Define utility constants for object names and testing timeouts/durations and  internal.
	const (
	...
	Context("When updating CronJob Status", func() {
		It("Should increase CronJob Status.Active count when new Jobs are created", func() {
					...
					JobTemplate: batchv1.JobTemplateSpec{
						Spec: batchv1.JobSpec{
							...
							Template: v1.PodTemplateSpec{
								Spec: v1.PodSpec{
									//	For simiplity, we only fill out the required field.
			...
			//	We'll need to retry getting this newly created CronJob,
			...
			By("By checking CronJob has zero active Jobs")
